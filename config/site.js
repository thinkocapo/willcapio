module.exports = {
  ...
  title: 'WillCap.io', // Navigation and Site Title
  titleAlt: 'WillCap.io', // Title for JSONLD
  description: 'life',
  ...
  author: 'Will', // Author for schemaORGJSONLD
  themeColor: '#3e7bf2',
  backgroundColor: '#d3e0ff',
  twitter: '@thinkocapo', // Twitter Username
};
